...
!function () {
    ...
    function t(e) {
        ...
        n("click", i, o.x, o.y), h(i)
    }

    function n(e, t, n, i) {
        var o = document.createEvent("MouseEvents");
        o.initMouseEvent(e, !0, !0, window, 1, 0, 0, n, i, !1, !1, !1, !1, 0, null), o.isIonicTap = !0, t.dispatchEvent(o)
    }
    ...
    function o(t) {
        if (!t.isIonicTap && !_(t)) {
            if (X)return t.stopPropagation(), ionic.tap.isTextInput(t.target) && B === t.target || /^(select|option)$/i.test(t.target.tagName) || t.preventDefault(), !1;
            $ = !1, U = ionic.tap.pointerCoord(t), e("mousemove"), ionic.activator.start(t)
        }
    }
    ...
    function u(t) {
        e(K, !1), ionic.activator.end(), $ = !1
    }

    function d() {
        X = !0, clearTimeout(W), W = setTimeout(function () {
            X = !1
        }, 600)
    }
    ...
    function h(e) {
        q = null;
        var t = !1;
        "SELECT" == e.tagName ? (n("mousedown", e, 0, 0), e.focus && e.focus(), t = !0) : g() === e ? t = !0 : /^(input|textarea)$/i.test(e.tagName) || e.isContentEditable ? (t = !0, e.focus && e.focus(), e.value = e.value, X && (q = e)) : f(), t && (g(e), ionic.trigger("ionic.focusin", {target: e}, !0))
    }
    ...
    function p(e) {
        X && ionic.tap.isTextInput(g()) && ionic.tap.isTextInput(q) && q !== e.target && (q.focus(), q = null), ionic.scroll.isScrolling = !1
    }
    ...
    function v(e) {
        ...
        var t = ionic.tap.pointerCoord(e), n = !(!e.target.classList || !e.target.classList.contains || "function" != typeof e.target.classList.contains), i = n && e.target.classList.contains("button") ? j : Z;
    ...
    function S() {
        var e = ionic.debounce(w, 200, !0);
        V() ? (window.addEventListener("native.keyboardshow", ionic.debounce(b, 100, !0)), window.addEventListener("native.keyboardhide", y)) : document.body.addEventListener("focusout", y), document.body.addEventListener("ionic.focusin", e), document.body.addEventListener("focusin", e), window.navigator.msPointerEnabled ? document.removeEventListener("MSPointerDown", S) : document.removeEventListener("touchstart", S)
    }

    function b(e) {
        clearTimeout(ie), (!ionic.keyboard.isOpen || ionic.keyboard.isClosing) && (ionic.keyboard.isOpening = !0, ionic.keyboard.isClosing = !1), ionic.keyboard.height = e.keyboardHeight, se ? M(A, !0) : M(C, !0)
    }

    function w(e) {
        clearTimeout(ie), e.target && !e.target.readOnly && ionic.tap.isKeyboardElement(e.target) && (te = k(e.target)) && (ee = e.target, document.body.scrollTop = 0, te.scrollTop = 0, ionic.requestAnimationFrame(function () {
            document.body.scrollTop = 0, te.scrollTop = 0
        }), (!ionic.keyboard.isOpen || ionic.keyboard.isClosing) && (ionic.keyboard.isOpening = !0, ionic.keyboard.isClosing = !1), document.addEventListener("keydown", L, !1), window.navigator.msPointerEnabled ? document.addEventListener("MSPointerMove", x, !1) : document.addEventListener("touchmove", x, !1), ionic.keyboard.isOpen || V() ? ionic.keyboard.isOpen && C() : M(C, !0))
    }
    ...
    function D() {
        ionic.keyboard.isLandscape = !ionic.keyboard.isLandscape, ionic.Platform.isIOS() && A(), ionic.Platform.isAndroid() && (ionic.keyboard.isOpen && V() ? se = !0 : M(A, !1))
    }
    ...
    function M(e, t) {
        clearInterval(ne);
        var n, i = 0, o = G(), r = o;
        n = ionic.Platform.isAndroid() && ionic.Platform.version() < 4.4 ? 30 : ionic.Platform.isAndroid() ? 10 : 1, ne = setInterval(function () {
            r = G(), (!(++i < n) || (I(r) || O(r)) && ionic.keyboard.height) && (V() || (ionic.keyboard.height = Math.abs(o - window.innerHeight)), ionic.keyboard.isOpen = t, clearInterval(ne), e())
        }, 50)
    }

    function N() {
        clearTimeout(ie), ionic.keyboard.isOpen = !1, ionic.keyboard.isClosing = !1, ionic.trigger("resetScrollView", {target: ee}, !0), ionic.requestAnimationFrame(function () {
            document.body.classList.remove(ae)
        }), window.navigator.msPointerEnabled ? document.removeEventListener("MSPointerMove", x) : document.removeEventListener("touchmove", x), document.removeEventListener("keydown", L), ionic.Platform.isAndroid() && (V() && cordova.plugins.Keyboard.close(), ee && ee.blur())
    }

    function C() {
        var e = ee.getBoundingClientRect(), t = {
            target: ee,
            elementTop: Math.round(e.top),
            elementBottom: Math.round(e.bottom),
            keyboardHeight: ionic.keyboard.height,
            viewportHeight: Q
        };
        return t.windowHeight = t.viewportHeight - t.keyboardHeight, t.isElementUnderKeyboard = t.elementBottom > t.windowHeight, ionic.keyboard.isOpen = !0, ionic.keyboard.isOpening = !1, ionic.trigger("scrollChildIntoView", t, !0), setTimeout(function () {
    ...
    function A() {
        se = !1, Q = G(), ionic.keyboard.isLandscape && !re ? re = Q : ionic.keyboard.isLandscape || oe || (oe = Q), ionic.trigger("resetScrollView", {target: ee}, !0), ionic.keyboard.isOpen && ionic.tap.isTextInput(ee) && C()
    }

    function P(e) {
        var t = G();
        t / window.innerWidth < 1 && (ionic.keyboard.isLandscape = !0), (e && t != Q || !e) && (Q = t, ionic.keyboard.isLandscape && !re ? re = Q : ionic.keyboard.isLandscape || oe || (oe = Q))
    }

    function G() {
        var e = window.innerHeight;
        return ionic.Platform.isAndroid() && ionic.Platform.isFullScreen || !ionic.keyboard.isOpen && !ionic.keyboard.isOpening || ionic.keyboard.isClosing ? e : e + ionic.keyboard.height
    }

    function k(e) {
        for (; e;) {
            if (e.classList.contains(le))return e;
            e = e.parentElement
        }
        return null
    }
    ...
    function R() {
        ...
        for (e = 0; e < document.head.children.length; e++)if ("viewport" == document.head.children[e].name) {
            ce = document.head.children[e];
            break
        }
        if (ce) {
            var t, n = ce.content.toLowerCase().replace(/\s+/g, "").split(",");
            for (e = 0; e < n.length; e++)n[e] && (t = n[e].split("="), ue[t[0]] = t.length > 1 ? t[1] : "_");
            z()
        }
    }

    function z() {
        var e = ue.width, t = ue.height, n = ionic.Platform, i = n.version(), o = "device-width", r = "device-height", s = ionic.viewport.orientation();
        delete ue.height, ue.width = o, n.isIPad() ? i > 7 ? delete ue.width : n.isWebView() ? 90 == s ? ue.height = "0" : 7 == i && (ue.height = r) : 7 > i && (ue.height = "0") : n.isIOS() && (n.isWebView() ? i > 7 ? delete ue.width : 7 > i ? t && (ue.height = "0") : 7 == i && (ue.height = r) : 7 > i && t && (ue.height = "0")), (e !== ue.width || t !== ue.height) && H()
    }

    function H() {
        var e, t = [];
        for (e in ue)ue[e] && t.push(e + ("_" == ue[e] ? "" : "=" + ue[e]));
        ce.content = t.join(", ")
    }

    window.ionic = window.ionic || {}, window.ionic.views = {}, window.ionic.version = "1.0.0-rc.3", function (e) {
        e.DelegateService = function (e) {
            ...
            return ["$log", function (n) {
                ...
                function r(e) {
                    return function () {
                        var t, i = this.handle, o = arguments, r = 0;
                ...
                return e.forEach(function (e) {
                    ...
                    return e.$$delegateHandle = n, e.$$filterFn = i || t, o.push(e), function () {
                        var t = o.indexOf(e);
                        -1 !== t && o.splice(t, 1)
                    }
        ...
        function i() {
            ...
            o = [], t.removeEventListener("DOMContentLoaded", i)
        }

        var o = [], r = "complete" === t.readyState || "interactive" === t.readyState;
        r || t.addEventListener("DOMContentLoaded", i), e._rAF = function () {
        ...
        e.CustomEvent = function () {
            ...
            trigger: function (t, n, i, o) {
                var r = new e.CustomEvent(t, {detail: n, bubbles: !!i, cancelable: !!o});
        ...
        e.Gesture = function (t, n) {
            ...
            on: function (e, t) {
                ...
                var o = this.element;
                return e.Gestures.utils.hasParent(n.target, o) && (o = n.target), o.dispatchEvent(i), this
            }, enable: function (e) {
        ...
        e.Gestures.event = {
            bindDom: function (e, t, n) {
                ...
                var a = this;
                this.bindDom(t, e.Gestures.EVENT_TYPES[r], function (l) {
                    var c = l.type.toLowerCase();
                    if (!c.match(/mouse/) || !o) {
                        c.match(/touch/) || c.match(/pointerdown/) || c.match(/mouse/) && 1 === l.which ? i = !0 : c.match(/mouse/) && 1 !== l.which && (i = !1), c.match(/touch|pointer/) && (o = !0);
                        var u = 0;
            ...
            extend: function (e, t, n) {
                ...
                for (var t = [], n = [], i = 0, o = e.length; o > i; i++)t.push(e[i].pageX), n.push(e[i].pageY);
                return {
                ...
                var i = Math.abs(t.pageX - n.pageX), o = Math.abs(t.pageY - n.pageY);
            ...
            detect: function (t) {
                if (this.current && !this.stopped) {
                    ...
                    for (var n = this.current.inst.options, i = 0, o = this.gestures.length; o > i; i++) {
            ...
            extendEventData: function (t) {
                ...
                if (n && (t.touches.length != n.touches.length || t.touches === n.touches)) {
                    n.touches = [];
                    for (var i = 0, o = t.touches.length; o > i; i++)n.touches.push(e.Gestures.utils.extend({}, t.touches[i]))
                }
                var r = t.timeStamp - n.timeStamp, s = t.center.pageX - n.center.pageX, a = t.center.pageY - n.center.pageY, l = e.Gestures.utils.getVelocity(r, s, a);
            ...
            handler: function (t, n) {
                if (t.eventType == e.Gestures.EVENT_END && "touchcancel" != t.srcEvent.type) {
                    var i = e.Gestures.detection.previous, o = !1;
            ...
            triggered: !1,
            handler: function (t, n) {
                if ("touchstart" == t.srcEvent.type || "touchend" == t.srcEvent.type ? this.preventedFirstMove = !1 : this.preventedFirstMove || "touchmove" != t.srcEvent.type || (-1 != n.options.prevent_default_directions.indexOf(t.direction) && t.srcEvent.preventDefault(), this.preventedFirstMove = !0), e.Gestures.detection.current.name != this.name && this.triggered)return n.trigger(this.name + "end", t), void(this.triggered = !1);
                if (!(n.options.drag_max_touches > 0 && t.touches.length > n.options.drag_max_touches))switch (t.eventType) {
                    ...
                    case e.Gestures.EVENT_MOVE:
                        ...
                        t.drag_locked_to_axis && o !== t.direction && (t.direction = e.Gestures.utils.isVertical(o) ? t.deltaY < 0 ? e.Gestures.DIRECTION_UP : e.Gestures.DIRECTION_DOWN : t.deltaX < 0 ? e.Gestures.DIRECTION_LEFT : e.Gestures.DIRECTION_RIGHT), this.triggered || (n.trigger(this.name + "start", t), this.triggered = !0), n.trigger(this.name, t), n.trigger(this.name + t.direction, t), (n.options.drag_block_vertical && e.Gestures.utils.isVertical(t.direction) || n.options.drag_block_horizontal && !e.Gestures.utils.isVertical(t.direction)) && t.preventDefault();
                        break;
                    case e.Gestures.EVENT_END:
            ...
            handler: function (t, n) {
                ...
                if (!(t.touches.length < 2))switch (n.options.transform_always_block && t.preventDefault(), t.eventType) {
                    case e.Gestures.EVENT_START:
                        ...
                        break;
                    case e.Gestures.EVENT_MOVE:
                        var i = Math.abs(1 - t.scale), o = Math.abs(t.rotation);
                        if (i < n.options.transform_min_scale && o < n.options.transform_min_rotation)return;
                        e.Gestures.detection.current.name = this.name, this.triggered || (n.trigger(this.name + "start", t), this.triggered = !0), n.trigger(this.name, t), o > n.options.transform_min_rotation && n.trigger("rotate", t), i > n.options.transform_min_scale && (n.trigger("pinch", t), n.trigger("pinch" + (t.scale < 1 ? "in" : "out"), t));
                        break;
                    case e.Gestures.EVENT_END:
                        this.triggered && n.trigger(this.name + "end", t), this.triggered = !1
                }
        ...
        var s, a = "ios", l = "android", c = "windowsphone", u = n.requestAnimationFrame, d = n.Platform = {
            ...
            _checkPlatforms: function () {
                d.platforms = [];
                var t = "a";
                d.isWebView() ? (d.platforms.push("webview"), e.cordova || e.PhoneGap || e.phonegap ? d.platforms.push("cordova") : e.forge && d.platforms.push("trigger")) : d.platforms.push("browser"), d.isIPad() && d.platforms.push("ipad");
                var n = d.platform();
                if (n) {
                    d.platforms.push(n);
                    var i = d.version();
                    if (i) {
                        var o = i.toString();
                        o.indexOf(".") > 0 ? o = o.replace(".", "_") : o += "_0", d.platforms.push(n + o.split("_")[0]), d.platforms.push(n + o), d.isAndroid() && 4.4 > i ? t = 4 > i ? "c" : "b" : d.isWindowsPhone() && (t = "b")
                    }
                }
                d.setGrade(t)
            },
        ...
        t.CSS = {}, function () {
            ...
            t.CSS.TRANSITION_DURATION = (o ? "-webkit-" : "") + "transition-duration", t.CSS.TRANSITIONEND = (o ? "webkitTransitionEnd " : "") + "transitionend"
    ...
    var F, Y, X, W, $, U, q, B, K = "touchmove", Z = 12, j = 50, J = {
        click: i,
        mousedown: o,
        mouseup: r,
        mousemove: s,
    ...
    ionic.tap = {
        register: function (t) {
            return F = t, e("click", !0, !0), e("mouseup"), e("mousedown"), window.navigator.pointerEnabled ? (e("pointerdown"),
                e("pointerup"), e("pointcancel"), K = "pointermove") : window.navigator.msPointerEnabled ? (e("MSPointerDown"), e("MSPointerUp"), e("MSPointerCancel"), K = "MSPointerMove") : (e("touchstart"), e("touchend"), e("touchcancel")), e("focusin"), e("focusout"), function () {
                for (var t in J)e(t, !1);
                F = null, Y = null, X = !1, $ = !1, U = null
            }
        ...
        e.Utils = {
            arrayMove: function (e, t, n) {
                ...
                return function () {
                    ...
                    return i || (i = setTimeout(l, t)), c && (a = e.apply(r, o)), a
                }
                ...
                return function () {
                    ...
                    a || n.leading !== !1 || (a = c);
                    var u = t - (c - a);
                    return i = this, o = arguments, 0 >= u ? (clearTimeout(s), s = null, a = c, r = e.apply(i, o)) : s || n.trailing === !1 || (s = setTimeout(l, u)), r
                }
    ...
    var Q, ee, te, ne, ie, oe = 0, re = 0, se = !1, ae = "keyboard-open", le = "scroll-content";
    ionic.keyboard = {
        isOpen: !1, isClosing: !1, isOpening: !1, height: 0, isLandscape: !1, hide: function () {
            V() && cordova.plugins.Keyboard.close(), ee && ee.blur()
        }, show: function () {
            V() && cordova.plugins.Keyboard.show()
        }
    }, Q = G(), ionic.Platform.ready(function () {
        P(), window.addEventListener("orientationchange", D), setTimeout(P, 999), window.navigator.msPointerEnabled ? document.addEventListener("MSPointerDown", S, !1) : document.addEventListener("touchstart", S, !1)
    });
    var ce, ue = {};
    ionic.viewport = {
    ...
    !function (e) {
        ...
        de.effect.Animate = {
            requestAnimationFrame: function () {
                ...
                return function (e, t) {
                    var n = s++;
                    return o[n] = e, r++, null === a && (a = setInterval(function () {
                        var e = +new Date, t = o;
                        o = {}, r = 0;
                ...
                var v = function (r) {
                    var m = r !== !0, g = t();
                    if (!o[p] || s && !s(p))return o[p] = null, void(a && a(n - f / ((g - d) / i), p, !1));
                    if (m)for (var T = Math.round((g - _) / (i / n)) - 1, E = 0; E < Math.min(T, 4); E++)v(!0), f++;
                    l && (h = (g - d) / l, h > 1 && (h = 1));
                    var S = c ? c(h) : h;
                    e(S, g, m) !== !1 && 1 !== h || !m ? m && (_ = g, de.effect.Animate.requestAnimationFrame(v, u)) : (o[p] = null, a && a(n - f / ((g - d) / i), p, 1 === h || null == l))
                };
                return o[p] = !0, de.effect.Animate.requestAnimationFrame(v, u), p
            }
        }
    }(this);
    !function (e) {
        ...
        e.views.Scroll = e.views.View.inherit({
            ...
            __initEventHandlers: function () {
                ...
                var n, i = this, o = i.__container;
                if (i.scrollChildIntoView = function (t) {
                        var r = o.getBoundingClientRect().bottom;
                        n = o.offsetHeight;
                        var s = i.isShrunkForKeyboard, a = o.parentNode.classList.contains("modal"), l = a && window.innerWidth >= 680;
                        if (!s) {
                            if (e.Platform.isIOS() || e.Platform.isFullScreen || l) {
                                var c = t.detail.viewportHeight - r, u = Math.max(0, t.detail.keyboardHeight - c);
                                e.requestAnimationFrame(function () {
                                    n -= u, o.style.height = n + "px", i.resize()
                                })
                            }
                            i.isShrunkForKeyboard = !0
                        }
                        t.detail.isElementUnderKeyboard && e.requestAnimationFrame(function () {
                            o.scrollTop = 0, i.isShrunkForKeyboard && !s && (r = o.getBoundingClientRect().bottom);
                            var a = .5 * n, l = (t.detail.elementBottom + t.detail.elementTop) / 2, c = l - r, u = c + a;
                            u > 0 && (e.Platform.isIOS() && e.tap.cloneFocusedInput(o, i), i.scrollBy(0, u, !0), i.onScroll())
                        }), t.stopPropagation()
                    }, i.resetScrollView = function (e) {
                        i.isShrunkForKeyboard && (i.isShrunkForKeyboard = !1, o.style.height = ""), i.resize()
                        ...
                        if (!(i.options.freeze || !i.__isDown || !i.__isDown && n.defaultPrevented || "TEXTAREA" === n.target.tagName && n.target.parentElement.querySelector(":focus"))) {
                            ...
                            if (i.startCoordinates) {
                                ...
                                i.__isSelectable && e.tap.isTextInput(n.target) && Math.abs(i.startCoordinates.x - r.x) > 20 && (i.__enableScrollY = !1, i.__isSelectable = !0), i.__enableScrollY && Math.abs(i.startCoordinates.y - r.y) > 10 && (i.__isSelectable = !1, e.tap.cloneFocusedInput(o, i))
                            }
            ...
            __repositionScrollbars: function () {
                var e, t, n, i, o, r = this, s = 0, a = 0;
                if (r.__indicatorX) {
                    r.__indicatorY && (s = 10), i = Math.round(r.__indicatorX.sizeRatio * r.__scrollLeft) || 0, t = r.__scrollLeft - (r.__maxScrollLeft - s), r.__scrollLeft < 0 ? (widthScale = Math.max(r.__indicatorX.minScale, (r.__indicatorX.size - Math.abs(r.__scrollLeft)) / r.__indicatorX.size), i = 0, r.__indicatorX.indicator.style[r.__transformOriginProperty] = "left center") : t > 0 ? (widthScale = Math.max(r.__indicatorX.minScale, (r.__indicatorX.size - t) / r.__indicatorX.size), i = r.__indicatorX.maxPos - s, r.__indicatorX.indicator.style[r.__transformOriginProperty] = "right center") : (i = Math.min(r.__maxScrollLeft, Math.max(0, i)), widthScale = 1);
                    var l = "translate3d(" + i + "px, 0, 0) scaleX(" + widthScale + ")";
                    r.__indicatorX.transformProp !== l && (r.__indicatorX.indicator.style[r.__transformProperty] = l, r.__indicatorX.transformProp = l)
                }
                if (r.__indicatorY) {
                    o = Math.round(r.__indicatorY.sizeRatio * r.__scrollTop) || 0, r.__indicatorX && (a = 10), n = r.__scrollTop - (r.__maxScrollTop - a), r.__scrollTop < 0 ? (e = Math.max(r.__indicatorY.minScale, (r.__indicatorY.size - Math.abs(r.__scrollTop)) / r.__indicatorY.size), o = 0, "center top" !== r.__indicatorY.originProp && (r.__indicatorY.indicator.style[r.__transformOriginProperty] = "center top", r.__indicatorY.originProp = "center top")) : n > 0 ? (e = Math.max(r.__indicatorY.minScale, (r.__indicatorY.size - n) / r.__indicatorY.size), o = r.__indicatorY.maxPos - a, "center bottom" !== r.__indicatorY.originProp && (r.__indicatorY.indicator.style[r.__transformOriginProperty] = "center bottom", r.__indicatorY.originProp = "center bottom")) : (o = Math.min(r.__maxScrollTop, Math.max(0, o)), e = 1);
                    var c = "translate3d(0," + o + "px, 0) scaleY(" + e + ")";
                    r.__indicatorY.transformProp !== c && (r.__indicatorY.indicator.style[r.__transformProperty] = c, r.__indicatorY.transformProp = c)
                }
            },
            ...
            getRenderFn: function () {
                ...
                var o, r = {
                    ...
                    webkit: "Webkit",
                    presto: "O"
                }[e], s = document.createElement("div"), a = r + "Perspective", l = r + "Transform", c = r + "TransformOrigin";
                return t.__perspectiveProperty = l, t.__transformProperty = l, t.__transformOriginProperty = c, s.style[a] !== o ? function (e, i, o, r) {
                    var s = "translate3d(" + -e + "px," + -i + "px,0) scale(" + o + ")";
                    s !== t.contentTransform && (n.style[l] = s, t.contentTransform = s), t.__repositionScrollbars(), r || t.triggerScrollEvent()
            ...
            setDimensions: function (e, t, n, i, o) {
                var r = this;
                (e || t || n || i) && (e === +e && (r.__clientWidth = e), t === +t && (r.__clientHeight = t), n === +n && (r.__contentWidth = n), i === +i && (r.__contentHeight = i), r.__computeScrollMax(), r.__resizeScrollbars(), o || r.scrollTo(r.__scrollLeft, r.__scrollTop, !0, null, !0))
            },
            ...
            zoomTo: function (e, t, n, i) {
                ...
                o.__isDecelerating && (de.effect.Animate.stop(o.__isDecelerating), o.__isDecelerating = !1);
                var r = o.__zoomLevel;
                null == n && (n = o.__clientWidth / 2), null == i && (i = o.__clientHeight / 2), e = Math.max(Math.min(e, o.options.maxZoom), o.options.minZoom), o.__computeScrollMax(e);
                var s = (n + o.__scrollLeft) * e / r - n, a = (i + o.__scrollTop) * e / r - i;
                s > o.__maxScrollLeft ? s = o.__maxScrollLeft : 0 > s && (s = 0), a > o.__maxScrollTop ? a = o.__maxScrollTop : 0 > a && (a = 0), o.__publish(s, a, e, t)
            },
            ...
            scrollTo: function (e, t, n, i, o) {
                var r = this;
                if (r.__isDecelerating && (de.effect.Animate.stop(r.__isDecelerating), r.__isDecelerating = !1), null != i && i !== r.__zoomLevel) {
            ...
            scrollBy: function (e, t, n) {
                var i = this, o = i.__isAnimating ? i.__scheduledLeft : i.__scrollLeft, r = i.__isAnimating ? i.__scheduledTop : i.__scrollTop;
            ...
            doTouchStart: function (e, t) {
                var n = this;
                n.__decStopped = !(!n.__isDecelerating && !n.__isAnimating), n.hintResize(), t instanceof Date && (t = t.valueOf()), "number" != typeof t && (t = Date.now()), n.__interruptedAnimation = !0, n.__isDecelerating && (de.effect.Animate.stop(n.__isDecelerating), n.__isDecelerating = !1, n.__interruptedAnimation = !0), n.__isAnimating && (de.effect.Animate.stop(n.__isAnimating), n.__isAnimating = !1, n.__interruptedAnimation = !0);
                var i, o, r = 1 === e.length;
                r ? (i = e[0].pageX, o = e[0].pageY) : (i = Math.abs(e[0].pageX + e[1].pageX) / 2, o = Math.abs(e[0].pageY + e[1].pageY) / 2), n.__initialTouchLeft = i, n.__initialTouchTop = o, n.__initialTouches = e, n.__zoomLevelStart = n.__zoomLevel, n.__lastTouchLeft = i, n.__lastTouchTop = o, n.__lastTouchMove = t, n.__lastScale = 1, n.__enableScrollX = !r && n.options.scrollingX, n.__enableScrollY = !r && n.options.scrollingY, n.__isTracking = !0, n.__didDecelerationComplete = !1, n.__isDragging = !r, n.__isSingleTouch = r, n.__positions = []
            },
            doTouchMove: function (e, t, n) {
                ...
                if (i.__isTracking) {
                    ...
                    if (i.__isDragging) {
                        i.__decStopped = !1;
                        var a = o - i.__lastTouchLeft, l = r - i.__lastTouchTop, c = i.__scrollLeft, u = i.__scrollTop, d = i.__zoomLevel;
                        if (null != n && i.options.zooming) {
                            var _ = d;
                            if (d = d / i.__lastScale * n, d = Math.max(Math.min(d, i.options.maxZoom), i.options.minZoom), _ !== d) {
                                var h = o - i.__clientLeft, f = r - i.__clientTop;
                        ...
                        var g = i.options.locking ? 3 : 0, v = 5, T = Math.abs(o - i.__initialTouchLeft), E = Math.abs(r - i.__initialTouchTop);
            ...
            doTouchEnd: function (t, n) {
                ...
                if (i.__isTracking) {
                    if (i.__isTracking = !1, i.__isDragging)if (i.__isDragging = !1, i.__isSingleTouch && i.options.animating && n - i.__lastTouchMove <= 100) {
                        for (var o = i.__positions, r = o.length - 1, s = r, a = r; a > 0 && o[a] > i.__lastTouchMove - 100; a -= 3)s = a;
                        if (s !== r) {
                            var l = o[r] - o[s], c = i.__scrollLeft - o[s - 2], u = i.__scrollTop - o[s - 1];
            ...
            __publish: function (e, t, o, r, s) {
                ...
                if (l && (de.effect.Animate.stop(l), a.__isAnimating = !1), r && a.options.animating) {
                    a.__scheduledLeft = e, a.__scheduledTop = t, a.__scheduledZoom = o;
                    var c = a.__scrollLeft, u = a.__scrollTop, d = a.__zoomLevel, _ = e - c, h = t - u, f = o - d, p = function (e, t, n) {
                    ...
                    a.__isAnimating = de.effect.Animate.start(p, m, g, a.options.animationDuration, l ? n : i)
            ...
            __computeScrollMax: function (e) {
                var t = this;
                null == e && (e = t.__zoomLevel), t.__maxScrollLeft = Math.max(t.__contentWidth * e - t.__clientWidth, 0),
                    t.__maxScrollTop = Math.max(t.__contentHeight * e - t.__clientHeight, 0), t.__didWaitForSize || t.__maxScrollLeft || t.__maxScrollTop || (t.__didWaitForSize = !0, t.__waitForSize())
            },
            ...
            __startDeceleration: function (e) {
                var t = this;
                if (t.options.paging) {
                    var n = Math.max(Math.min(t.__scrollLeft, t.__maxScrollLeft), 0), i = Math.max(Math.min(t.__scrollTop, t.__maxScrollTop), 0), o = t.__clientWidth, r = t.__clientHeight;
                ...
                } else t.__minDecelerationScrollLeft = 0, t.__minDecelerationScrollTop = 0, t.__maxDecelerationScrollLeft = t.__maxScrollLeft, t.__maxDecelerationScrollTop = t.__maxScrollTop, t.__refreshActive && (t.__minDecelerationScrollTop = -1 * t.__refreshHeight);
                ...
                var a = function () {
                    ...
                    return e || (t.__didDecelerationComplete = !0, t.options.bouncing && !t.__refreshActive && t.scrollTo(Math.min(Math.max(t.__scrollLeft, 0), t.__maxScrollLeft), Math.min(Math.max(t.__scrollTop, 0), t.__maxScrollTop), t.__refreshActive)), e
                }, l = function (e, n, i) {
                ...
                t.__isDecelerating = de.effect.Animate.start(s, a, l)
            },
        ...
        e.views.ScrollNative = e.views.View.inherit({
            initialize: function (n) {
                ...
                var o = this;
                (e || t || n || i) && (e === +e && (o.__clientWidth = e), t === +t && (o.__clientHeight = t), n === +n && (o.__contentWidth = n), i === +i && (o.__contentHeight = i), o.__computeScrollMax())
            }, getScrollMax: function () {
                return {left: this.__maxScrollLeft, top: this.__maxScrollTop}
            }, scrollBy: function (e, t, n) {
                var i = this;
                i.update();
                var o = i.__isAnimating ? i.__scheduledLeft : i.__scrollLeft, r = i.__isAnimating ? i.__scheduledTop : i.__scrollTop;
                i.scrollTo(o + (e || 0), r + (t || 0), n)
                ...
                function o(t, n) {
                    ...
                    function o() {
                        var u = Date.now(), d = Math.min(1, (u - s) / a), _ = i(d);
                        l != t && (r.el.scrollTop = parseInt(_ * (t - l) + l, 10)), c != n && (r.el.scrollLeft = parseInt(_ * (n - c) + c, 10)), 1 > d ? e.requestAnimationFrame(o) : r.resize()
                    }

                    var s = Date.now(), a = 1e3, l = r.el.scrollTop, c = r.el.scrollLeft;
                ...
                var n = this, i = n.__container;
                n.scrollChildIntoView = t, n.resetScrollView = function (t) {
        ...
        "use strict";
        var t = "item", n = "item-content", i = "item-sliding", o = "item-options", r = "item-placeholder", s = "item-reordering", a = "item-reorder", l = function () {
        };
        l.prototype = {
            start: function (e) {
            }, drag: function (e) {
            }, end: function (e) {
            }, isSameItem: function (e) {
                return !1
            }
        };
        var c = function (e) {
        ...
        c.prototype = new l, c.prototype.start = function (r) {
            ...
            t.gesture.deltaX > -(i._currentDrag.buttonsWidth / 2) && ("left" == t.gesture.direction && Math.abs(t.gesture.velocityX) < .3 ? o = 0 : "right" == t.gesture.direction && (o = 0)), e.requestAnimationFrame(function () {
                if (0 === o) {
        ...
        u.prototype = new l, u.prototype._moveElement = function (t) {
            ...
            var n = e.DomUtil.getChildIndex(this.el, this.el.nodeName.toLowerCase()), i = this.el.scrollHeight, o = this.el.cloneNode(!0);
            o.classList.add(r), this.el.parentNode.insertBefore(o, this.el), this.el.classList.add(s), this._currentDrag = {
                elementHeight: i,
                startIndex: n,
                placeholder: o,
                scrollHeight: scroll,
            ...
            if (this._currentDrag) {
                var i = 0, o = t.gesture.center.pageY, r = this.listElTrueTop;
                if (this.scrollView) {
                    var s = this.scrollView.__container;
                    i = this.scrollView.getValues().top;
                    var a = s.offsetTop, l = a - o + this._currentDrag.elementHeight / 2, c = o + this._currentDrag.elementHeight / 2 - a - s.offsetHeight;
            ...
            var i = this._currentDrag.placeholder, o = this._getReorderIndex();
            this.el.classList.remove(s), this.el.style[e.CSS.TRANSFORM] = "", i.parentNode.insertBefore(this.el, i), i.parentNode.removeChild(i), this.onReorder && this.onReorder(this.el, this._currentDrag.startIndex, o), this._currentDrag = {
                placeholder: null,
                content: null
            ...
            initialize: function (t) {
                ...
                var t = this;
                if (t.isVirtual) {
                    var n = t.itemHeight, i = (t.listEl.children.length, e.target.scrollHeight), o = t.el.parentNode.offsetHeight, r = (e.scrollTop, Math.max(0, e.scrollTop + t.virtualRemoveThreshold)), s = Math.min(i, Math.abs(e.scrollTop) + o + t.virtualAddThreshold), a = Math.floor((s - r) / n), l = parseInt(Math.abs(r / n), 10), c = parseInt(Math.abs(s / n), 10);
                    ...
                    t.renderViewport && t.renderViewport(r, s, l, c)
                }
        ...
        e.views.SideMenu = e.views.View.inherit({
            ...
            initialize: function (t) {
                e.extend(this, {
                    animationClass: "menu-animated", onDrag: function (e) {
        ...
        e.views.Slider = e.views.View.inherit({
            initialize: function (e) {
                ...
                function n() {
                    e.continuous ? r(S - 1) : S && r(S - 1)
                }

                function i() {
                    e.continuous ? r(S + 1) : S < m.length - 1 && r(S + 1)
                }
                ...
                function r(t, n) {
                    if (S != t) {
                        if (f.transitions) {
                            ...
                            if (e.continuous) {
                                var r = i;
                                i = -g[o(t)] / v, i !== r && (t = -i * m.length + t)
                            }
                            for (var a = Math.abs(S - t) - 1; a--;)s(o((t > S ? t : S) - a - 1), v * i, 0);
                            t = o(t), s(S, v * i, n || b), s(t, 0, n || b), e.continuous && s(o(t - i), -(v * i), 0)
                        } else t = o(t), l(S * -v, t * -v, n || b);
                        ...
                        handleEvent: function (n) {
                            ...
                            if (!(t.touches.length > 1 || t.scale && 1 !== t.scale || d.slideIsDisabled)) {
                                ...
                                x = {
                                    x: n.pageX - L.x,
                                    y: n.pageY - L.y
                                }, "undefined" == typeof y && (y = !!(y || Math.abs(x.x) < Math.abs(x.y))), y || (t.preventDefault(), u(), e.continuous ? (a(o(S - 1), x.x + g[o(S - 1)], 0), a(S, x.x + g[S], 0), a(o(S + 1), x.x + g[o(S + 1)], 0)) : (x.x = x.x / (!S && x.x > 0 || S == m.length - 1 && x.x < 0 ? Math.abs(x.x) / v + 1 : 1), a(S - 1, x.x + g[S - 1], 0), a(S, x.x + g[S], 0), a(S + 1, x.x + g[S + 1], 0)), e.onDrag && e.onDrag())
                            }
                        }, end: function (t) {
                            var n = +new Date - L.time, i = Number(n) < 250 && Math.abs(x.x) > 20 || Math.abs(x.x) > v / 2, r = !S && x.x > 0 || S == m.length - 1 && x.x < 0;
                            e.continuous && (r = !1);
                            var a = x.x < 0;
                            y || (i && !r ? (a ? (e.continuous ? (s(o(S - 1), -v, 0), s(o(S + 2), v, 0)) : s(S - 1, -v, 0), s(S, g[S] - v, b), s(o(S + 1), g[o(S + 1)] - v, b), S = o(S + 1)) : (e.continuous ? (s(o(S + 1), v, 0), s(o(S - 2), -v, 0)) : s(S + 1, v, 0), s(S, g[S] + v, b), s(o(S - 1), g[o(S - 1)] + v, b), S = o(S - 1)), e.callback && e.callback(S, m[S])) : e.continuous ? (s(o(S - 1), -v, b), s(S, 0, b), s(o(S + 1), v, b)) : (s(S - 1, -v, b), s(S, 0, b), s(S + 1, v, b))), f.touch ? (E.removeEventListener("touchmove", M, !1), E.removeEventListener("touchend", M, !1)) : (E.removeEventListener("mousemove", M, !1), E.removeEventListener("mouseup", M, !1), document.removeEventListener("mouseup", M, !1)), e.onDragEnd && e.onDragEnd()
        ...
        e.views.Toggle = e.views.View.inherit({
            initialize: function (t) {
                ...
                var n = this;
                this._dragInfo && (t.gesture.srcEvent.preventDefault(), e.requestAnimationFrame(function (e) {
                    if (n._dragInfo) {
                        var i = (n.track.offsetLeft + n.handle.offsetWidth / 2, n.track.offsetLeft + n.track.offsetWidth - n.handle.offsetWidth / 2, t.gesture.deltaX, t.gesture.touches[0].pageX - n._dragInfo.left), o = n._dragInfo.width - n.triggerThreshold;
                        n._dragInfo.initialState ? i < n.triggerThreshold ? n.setOpenPercent(0) : i > n._dragInfo.triggerX && n.setOpenPercent(100) : i < n._dragInfo.triggerX ? n.setOpenPercent(0) : i > o && n.setOpenPercent(100)
                    }
                }))
            }, endDrag: function (e) {
                this._dragInfo = null
...
!function () {
    function e(e, t, n, i, o, r) {
        function a(i, a, c, s, l) {
            ...
            function v() {
                _ ? m(_, x) : x.computed = !0, z ? m(z, A) : A.computed = !0
            }
            ...
            function $() {
                H || l(O = i.$new(), function (e) {
                    e[0].removeAttribute("collection-repeat"), H = e[0]
                }), O[T] = (I(i) || [])[0], o.$$phase || O.$digest(), y.appendChild(H);
                var e = n.getComputedStyle(H);
                V.width = parseInt(e.width), V.height = parseInt(e.height), y.removeChild(H)
            }
            ...
            var C, T = k[1], B = k[2], I = t(B), x = {}, A = {}, V = {}, P = [], D = c.itemRenderBuffer || c.collectionBufferSize, L = angular.isDefined(D) ? parseInt(D) : E, _ = c.itemHeight || c.collectionItemHeight, z = c.itemWidth || c.collectionItemWidth, M = p(), N = d();
            v(), s.$element.on("scroll.resize", g), angular.element(n).on("resize", u);
            var R = o.$on("$ionicExposeAside", ionic.animationFrameThrottle(function () {
                s.scrollView.resize(), u()
            }));
            r(g, 0, !1), i.$watchCollection(I, function (e) {
                ...
                angular.element(n).off("resize", u), R(), s.$element && s.$element.off("scroll.resize", g), H && H.parentNode && H.parentNode.removeChild(H), O && O.$destroy(), O = H = null, C && C.destroy(), C = null
            });
            var H, O
        }
    ...
    function t(e, t, n) {
        var o = {primaryPos: 0, secondaryPos: 0, primarySize: 0, secondarySize: 0, rowPrimarySize: 0};
        return function (r) {
            function a() {
                return c(!0)
            }
            ...
            function v() {
                ...
                var n, r = this, a = ionic.debounce(ee, 25, !0), c = M ? t : e, s = [];
                this.getContentSize = function () {
                    var e = s[n] || o;
                    ...
                    return e = Math.min(e, E.length - 1), e > n && (e > .9 * E.length ? (c(E.length - 1), n = E.length - 1, ee()) : (c(e), n = e, a())), s[e]
                };
                var l = -1, u = -1;
                this.updateRenderRange = function (e, t) {
                    var n, i, o;
                    if (this.getDimensions(2 * this.getEstimatedIndex(t)), -1 === l || 0 === e)n = 0; else if (e >= u)for (n = l, i = E.length; i > n && !((o = this.getDimensions(n)) && o.primaryPos + o.rowPrimarySize >= e); n++); else for (n = l; n >= 0; n--)if ((o = this.getDimensions(n)) && o.primaryPos <= e) {
                        n = M ? o.rowStartIndex : n;
                        break
                    }
                    W = Math.min(Math.max(0, n), E.length - 1), G = -1 !== W ? this.getDimensions(W).primaryPos : -1;
                    var r;
                    for (n = W + 1, i = E.length; i > n; n++)if ((o = this.getDimensions(n)) && o.primaryPos + o.rowPrimarySize > t) {
                        if (M)for (r = o; i - 1 > n && (o = this.getDimensions(n + 1)).primaryPos === r.primaryPos;)n++;
                        break
                    }
                    X = Math.min(n, E.length - 1), Y = -1 !== X ? (o = this.getDimensions(X)).primaryPos + (o.rowPrimarySize || o.primarySize) : -1, u = e, l = W
                }
            }
            ...
            }, z = !!B.options.scrollingY, M = z ? S.dynamic || S.value !== B.__clientWidth : y.dynamic || y.value !== B.__clientHeight, N = !y.dynamic && !S.dynamic, R = "PRIMARY", H = "SECONDARY", O = z ? "translate3d(SECONDARYpx,PRIMARYpx,0)" : "translate3d(PRIMARYpx,SECONDARYpx,0)", U = z ? "height: PRIMARYpx; width: SECONDARYpx;" : "height: SECONDARYpx; width: PRIMARYpx;", q = 0, F = 0, W = -1, X = -1, Y = -1, G = -1, j = [], Z = [], K = [], J = {}, Q = 0, ee = z ? function () {
                B.setDimensions(null, null, null, te.getContentSize(), !0)
            } : function () {
                B.setDimensions(null, null, te.getContentSize(), null, !0)
            }, te = z ? new u : new d;
            (M ? f : h).call(te), (N ? p : v).call(te);
            var ne = z ? "getContentHeight" : "getContentWidth", ie = B.options[ne];
            B.options[ne] = angular.bind(te, te.getContentSize), B.__$callback = B.__callback, B.__callback = function (e, t, n, i) {
                var o = te.getScrollValue();
                window.d && dump("_-callback render", o, te.scrollPrimarySize + Y), (-1 === W || o + te.scrollPrimarySize > Y || G > o) && c(), B.__$callback(e, t, n, i)
            };
            var oe = !1, re = !1;
            this.refreshLayout = function (e) {
                g = D(0, E[0]), m = _(0, E[0]);
                var n = getComputedStyle($) || {}, i = $.firstElementChild && getComputedStyle($.firstElementChild) || {}, o = $.lastElementChild && getComputedStyle($.lastElementChild) || {};
                F = (parseInt(n[z ? "height" : "width"]) || 0) + (i && parseInt(i[z ? "marginTop" : "marginLeft"]) || 0) + (o && parseInt(o[z ? "marginBottom" : "marginRight"]) || 0), q = 0;
                var r = w;
                do q += r[z ? "offsetTop" : "offsetLeft"]; while (ionic.DomUtil.contains(B.__content, r = r.offsetParent));
                var c = w.previousElementSibling, s = c ? t.getComputedStyle(c) : {}, u = parseInt(s[z ? "marginBottom" : "marginRight"] || 0);
                if (w.style[ionic.CSS.TRANSFORM] = O.replace(R, -u).replace(H, 0), q -= u, B.__clientHeight && B.__clientWidth || (B.__clientWidth = B.__container.clientWidth, B.__clientHeight = B.__container.clientHeight), (te.onRefreshLayout || angular.noop)(), te.refreshDirection(), ee(), !oe)for (var d = Math.max(20, 3 * C), f = 0; d > f; f++)j.push(new l);
                oe = !0, oe && re && ((B.__scrollLeft > B.__maxScrollLeft || B.__scrollTop > B.__maxScrollTop) && B.resize(), a(!0))
            }, this.setData = function (e) {
                E = e, (te.onRefreshData || angular.noop)(), re = !0
            }, this.destroy = function () {
                c.destroyed = !0, j.forEach(function (e) {
                    e.scope.$destroy(), e.scope = e.element = e.node = e.images = null
                }), j.length = K.length = Z.length = 0, J = {}, B.options[ne] = ie, B.__callback = B.__$callback, B.resize(), (te.onDestroy || angular.noop)()
            }
        }
    }
    ...
    function r(e) {
        return ["$document", "$timeout", function (t, n) {
            return {
                restrict: "E", controller: "$ionicHeaderBar", compile: function (i, o) {
                    function r(t, n, i, o) {
                        e ? (t.$watch(function () {
    ...
    l.factory("$ionicActionSheet", ["$rootScope", "$compile", "$animate", "$timeout", "$ionicTemplateLoader", "$ionicPlatform", "$ionicBody", function (e, t, n, i, o, r, a) {
        ...
        return L.prototype.initialize = function (e) {
            ...
            register: function (e, t) {
                var i, a, l, u = v(), m = f(e), L = D.currentView, _ = D.backView, z = D.forwardView, M = null, N = null, R = V, H = m.historyId, O = n.url();
                if ($ !== u && ($ = u, P++), y)M = y.viewId, N = y.action, R = y.direction, y = null; else if (_ && _.stateId === u)M = _.viewId, H = _.historyId, N = C, _.historyId === L.historyId ? R = B : L && (R = A, i = d(_.historyId), i && i.parentHistoryId === L.historyId ? R = x : (i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId && (R = E))); else if (z && z.stateId === u)M = z.viewId, H = z.historyId, N = T, z.historyId === L.historyId ? R = I : L && (R = A, L.historyId === m.parentHistoryId ? R = x : (i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId && (R = E))), i = h(e), z.historyId && i.scope && (i.scope.$historyId = z.historyId, H = z.historyId); else if (L && L.historyId !== H && m.cursor > -1 && m.stack.length > 0 && m.cursor < m.stack.length && m.stack[m.cursor].stateId === u) {
                    var U = m.stack[m.cursor];
                    M = U.viewId, H = U.historyId, N = C, R = E, i = d(L.historyId), i && i.parentHistoryId === H ? R = A : (i = d(H), i && i.parentHistoryId === L.historyId && (R = x)), i = c(U.backViewId), i && U.historyId !== i.historyId && (m.stack[m.cursor].backViewId = L.viewId)
                } else {
                    ...
                    if (M = ionic.Utils.nextUid(), L) {
                        if (L.forwardViewId = M, N = k, z && L.stateId !== z.stateId && L.historyId === z.historyId && (i = d(z.historyId))) {
                            for (a = i.stack.length - 1; a >= z.index; a--) {
                                var q = i.stack[a];
                                q && q.destroy && q.destroy(), i.stack.splice(a)
                            }
                            H = z.historyId
                        }
                        m.historyId === L.historyId ? R = I : L.historyId !== m.historyId && (R = x, i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId ? R = E : (i = d(i.parentHistoryId), i && i.historyId === m.historyId && (R = A)))
                    } else N = S;
                    2 > P && (R = V), D.views[M] = this.createView({
                        viewId: M,
                ...
                if (o.cancel(b), w) {
                    if (w.disableAnimate && (R = V), w.disableBack && (D.views[M].backViewId = null), w.historyRoot) {
                ...
                if (p(M), D.backView && H == D.backView.historyId && u == D.backView.stateId && O == D.backView.url)for (a = 0; a < m.stack.length; a++)if (m.stack[a].viewId == M) {
                    N = "dupNav", R = V, a > 0 && (m.stack[a - 1].forwardViewId = null), D.forwardView = null, D.currentView.index = D.backView.index, D.currentView.backViewId = D.backView.backViewId, D.backView = s(D.backView), m.stack.splice(a, 1);
                    break
                }
    ...
    }]), l.factory("$ionicModal", ["$rootScope", "$ionicBody", "$compile", "$timeout", "$ionicPlatform", "$ionicTemplateLoader", "$q", "$log", "$ionicClickBlock", function (e, t, n, i, o, r, a, c, s) {
        var l = ionic.views.Modal.inherit({
            initialize: function (e) {
                ...
                }, 400), n.el.parentElement || (r.addClass(n.animation), t.append(n.el));
                var a = r.data("$$ionicScrollController");
                return a && a.resize(), e && n.positionView && (n.positionView(e, r), ionic.on("resize", function () {
                ...
                return s.show(600), e.el.classList.remove("active"), n.addClass("ng-leave"), i(function () {
    ...
    l.provider("$ionicPlatform", function () {
        ...
        function o(e, n) {
            var o = v(e.target || e), a = t.offset(o), c = n.prop("offsetWidth"), s = n.prop("offsetHeight"), l = i.innerWidth, u = i.innerHeight, d = {left: a.left + a.width / 2 - c / 2}, f = v(n[0].querySelector(".popover-arrow"));
            d.left < r ? d.left = r : d.left + c + r > l && (d.left = l - c - r), a.top + a.height + s > u && a.top - s > 0 ? (d.top = a.top - s, n.addClass("popover-bottom")) : (d.top = a.top + a.height, n.removeClass("popover-bottom")), f.css({left: a.left + a.width / 2 - f.prop("offsetWidth") / 2 - d.left + "px"}), n.css({
                top: d.top + "px",
                left: d.left + "px",
                marginLeft: "0",
                opacity: "1"
    ...
    l.factory("$ionicPopup", ["$ionicTemplateLoader", "$ionicBackdrop", "$q", "$timeout", "$rootScope", "$ionicBody", "$compile", "$ionicPlatform", function (e, t, n, i, o, r, a, c) {
        ...
        function h(e) {
            return d(u({
                buttons: [{
                    text: e.okText || "OK", type: e.okType || "button-positive", onTap: function (e) {
                        return !0
                    }
                }]
            }, e || {}))
        ...
        function m(e) {
            ...
            return e.template && /<[a-z][\s\S]*>/i.test(e.template) === !1 && (n = "<span>" + e.template + "</span>", delete e.template), d(u({
                ...
                scope: t,
                buttons: [{
                    text: e.cancelText || "Cancel", type: e.cancelType || "button-default", onTap: function (e) {
                    }
                }, {
                    text: e.okText || "OK", type: e.okType || "button-positive", onTap: function (e) {
        ...
        var E, V = ionic.DomUtil.cachedAttr, P = [], D = 1100, L = {
            create: function (t, d, v, T, E, _) {
                var z, M, N, R = ++A, H = {
                    init: function (e, t) {
                        L.isTransitioning(!0), H.loadViewElements(e), H.render(e, function () {
                            t && t()
                        })
                    }, loadViewElements: function (e) {
                        var n, i, o, r = t.getViewElements(), c = a(d, v), s = t.activeEleId();
                        for (n = 0, i = r.length; i > n && (o = r.eq(n), o.data(y) === c ? o.data(w) ? (o.data(y, c + ionic.Utils.nextUid()), o.data(b, !0)) : z = o : f(s) && o.data(y) === s && (M = o), !z || !M); n++);
                        N = !!z, N || (z = e.ele || L.createViewEle(d), z.data(y, c)), _ && t.activeEleId(c), e.ele = null
                    }, render: function (e, n) {
                        if (N)ionic.Utils.reconnectScope(z.scope()); else {
                            h(z, x);
                            var i = s(d, z, e.direction, v), r = o.transitions.views[i.transition] || o.transitions.views.none;
                            r(z, null, i.direction, !0).run(0), z.data(C, {
                                viewId: i.viewId,
                                historyId: i.historyId,
                                stateName: i.stateName,
                                stateParams: i.stateParams
                            }), (c(d).cache === !1 || "false" === c(d).cache || "false" == z.attr("cache-view") || 0 === o.views.maxCache()) && z.data(w, !0);
                            var a = t.appendViewElement(z, d);
                            delete i.direction, delete i.transition, a.$emit("$ionicView.loaded", i)
                        }
                        z.data(S, Date.now()), n && n()
                    }, transition: function (a, c, f) {
                        function p() {
                            h(z, F.shouldAnimate ? "entering" : B), h(M, F.shouldAnimate ? "leaving" : I), F.run(1), r._instances.forEach(function (e) {
                        ...
                        function b() {
                            b.x || (b.x = !0, z.off($, w), e.cancel(z.data(k)), M && e.cancel(M.data(k)), H.emit("after", O, U), C && C.resolve(t), R === A && (n.all(P).then(L.transitionEnd), H.cleanup(O)), r._instances.forEach(function (e) {
                        ...
                        function S() {
                            h(z, I), h(M, B), z.off($, y), e.cancel(z.data(k)), L.transitionEnd([t])
                        }

                        var C, O = s(d, z, a, v), U = u(u({}, O), l(T));
                        O.transitionId = U.transitionId = R, O.fromCache = !!N, O.enableBack = !!c, O.renderStart = E, O.renderEnd = _, V(z.parent(), "nav-view-transition", O.transition), V(z.parent(), "nav-view-direction", O.direction), e.cancel(z.data(k));
                        var q = o.transitions.views[O.transition] || o.transitions.views.none, F = q(z, M, O.direction, O.shouldAnimate && f && _);
                        if (F.shouldAnimate && (z.on($, w), z.data(k, e(b, D)), i.show(D)), E && (H.emit("before", O, U), h(z, x), F.run(0)), _ && (C = n.defer(), P.push(C.promise)), E && _)e(p, 16); else {
                            if (!_)return h(z, "entering"), h(M, "leaving"), {
                                run: F.run, cancel: function (t) {
                                    t ? (z.on($, y), z.data(k, e(S, D)), i.show(D)) : S(), F.shouldAnimate = t, F.run(0), F = null
                                }
                            };
                            _ && p()
                        }
        ...
        B.init = function () {
        ...
        }, B.createHeaderBar = function (o, r) {
            function c(e, t) {
                e && ("title" === t ? m.append(e) : "rightButtons" == t || t == k && "left" != a.navBar.positionSecondaryButtons() || t == S && "right" == a.navBar.positionPrimaryButtons() ? (g || (g = v('<div class="buttons buttons-right">'), h.append(g)), t == k ? g.append(e) : g.prepend(e)) : (p || (p = v('<div class="buttons buttons-left">'), $[C] ? $[C].after(p) : h.prepend(p)), t == k ? p.append(e) : p.prepend(e)))
            }

            var s = v('<div class="nav-bar-block">');
            ionic.DomUtil.cachedAttr(s, "nav-bar", o ? "active" : "cached");
            var u = n.alignTitle || a.navBar.alignTitle(), h = v("<ion-header-bar>").addClass(n["class"]).attr("align-title", u);
            f(n.noTapScroll) && h.attr("no-tap-scroll", n.noTapScroll);
            var p, g, m = v('<div class="title title-' + u + '">'), $ = {}, w = {};
            $[C] = l(C), $[C] && h.append($[C]), h.append(m), d(T, function (e) {
                $[e] = l(e), c($[e], e)
            });
            for (var y = 0; y < h[0].children.length; y++)h[0].children[y].classList.add("header-item");
            s.append(h), t.append(i(s)(e.$new()));
            var B = h.data("$ionHeaderBarController");
            B.backButtonIcon = a.backButton.icon(), B.backButtonText = a.backButton.text();
            var x = {
                isActive: o, title: function (e) {
                    B.title(e)
                }, setItem: function (e, t) {
                    x.removeItem(t), e ? ("title" === t && x.title(""), c(e, t), $[t] && $[t].addClass(b), w[t] = e) : $[t] && $[t].removeClass(b)
                }, removeItem: function (e) {
                    w[e] && (w[e].scope().$destroy(), w[e].remove(), w[e] = null)
                    ...
                    for (var e in $)$[e] && ($[e].removeData(), $[e] = null);
                    p && p.removeData(), g && g.removeData(), m.removeData(), h.removeData(), s.remove(), s = h = m = p = g = null
                }
            };
            return I.push(x), x
            ...
            function c() {
                ...
                n.isActive = !0, p(n, "active"), p(i, "cached"), B.activeTransition = d = $ = null
            }

            var s = n.controller(), l = a.transitions.navBar[r.navBarTransition] || a.transitions.navBar.none, u = r.transitionId;
            s.beforeEnter(r);
            var d = l(n, i, r.direction, r.shouldAnimate && B.isInitialized);
            ionic.DomUtil.cachedAttr(t, "nav-bar-transition", r.navBarTransition), ionic.DomUtil.cachedAttr(t, "nav-bar-direction", r.direction), d.shouldAnimate && r.renderEnd ? p(n, "stage") : (p(n, "entering"), p(i, "leaving")), s.resetBackButton(r), d.run(0), B.activeTransition = {
                run: function (e) {
                    d.shouldAnimate = !1, d.direction = "back", d.run(e)
                }, cancel: function (t, o, r) {
                    g(o), p(i, "active"), p(n, "cached"), d.shouldAnimate = t, d.run(0), B.activeTransition = d = null;
                    var a;
                    r.showBar !== B.showBar() && B.showBar(r.showBar), r.showBackButton !== B.showBackButton() && B.showBackButton(r.showBackButton), a && e.$apply()
                }, complete: function (e, t) {
                    g(t), d.shouldAnimate = e, d.run(1), $ = c
                }
            }, o(s.align, 16), (m = function () {
                w === u && (p(n, "entering"), p(i, "leaving"), d.run(1), $ = function () {
            ...
            e && !A ? (t.removeClass(b), B.align()) : !e && A && t.addClass(b), A = e
        }, B.enable = function (e) {
            B.visibleBar(e);
        ...
        I.scope = e, I.element = t, I.init = function () {
            ...
            function n(e) {
                if (x && (S = r(e), !(S > C) && (p = c.backView(), p && p.historyId === c.currentView().historyId))) {
                    ...
                    k = [], T = {showBar: I.showBar(), showBackButton: I.showBackButton()};
            ...
            function o(e) {
                if (x && u && k && k.length > 1) {
                    ...
                    } else h(y ? "" : "fast"), b = null, u.cancel(!y), f && f.activeTransition && f.activeTransition.cancel(!y, "fast", T), y = null
                }
            ...
            var u, f, p, v, m, $, w, S, k, C = l.views.swipeBackHitWidth(), T = {};
        ...
        var l, u = s.element = t.el, d = s.$element = v(u);
        l = s.scrollView = s.isNative() ? new ionic.views.ScrollNative(t) : new ionic.views.Scroll(t), (d.parent().length ? d.parent() : d).data("$$ionicScrollController", s);
        ...
        d.on("scroll", g), e.$on("$destroy", function () {
            h(), l && l.__cleanup && l.__cleanup(), angular.element(i).off("resize", p), d.off("scroll", g), l = s.scrollView = t = s._scrollViewOptions = t.el = s._scrollViewOptions.el = d = s.$element = u = null
        }), n(function () {
            l && l.run && l.run()
            ...
            s.resize().then(function () {
                ...
                var i = n, a = 0, c = 0, u = 0;
                do null !== i && (a += i.offsetLeft), null !== i && (c += i.offsetTop), i = i.offsetParent, u++; while (i.attributes != s.element.attributes && i.offsetParent);
                l.scrollTo(a, c, !!e)
            })
        }, s.freezeScroll = l.freeze, s.freezeAllScrolls = function (e) {
    ...
    }]), l.controller("$ionicView", ["$scope", "$element", "$attrs", "$compile", "$rootScope", "$ionicViewSwitcher", function (e, t, n, i, o, r) {
        function a() {
            var t = f(n.viewTitle) && "viewTitle" || f(n.title) && "title";
            t && (c(n[t]), w.push(n.$observe(t, c))), f(n.hideBackButton) && w.push(e.$watch(n.hideBackButton, function (e) {
                h.showBackButton(!e)
            })), f(n.hideNavBar) && w.push(e.$watch(n.hideNavBar, function (e) {
                h.showBar(!e)
            }))
        }

        function c(e) {
            f(e) && e !== g && (g = e, h.title(g))
        }
        ...
        var h, p, v, g, m = this, $ = {}, w = [], b = e.$on("ionNavBar.init", function (e, t) {
            e.stopPropagation(), p = t
        });
        m.init = function () {
            b();
            var n = t.inheritedData("$ionModalController");
            h = t.inheritedData("$ionNavViewController"), h && !n && (e.$on("$ionicView.beforeEnter", m.beforeEnter), e.$on("$ionicView.afterEnter", a), e.$on("$ionicView.beforeLeave", s))
        }, m.beforeEnter = function (t, i) {
            if (i && !i.viewNotified) {
                i.viewNotified = !0, o.$$phase || e.$digest(), g = f(n.viewTitle) ? n.viewTitle : n.title;
                var r = {};
                for (var a in $)r[a] = l($[a]);
                h.beforeEnter(u(i, {
                    title: g,
        ...
        return {
            restrict: "E", require: "^?ionNavView", scope: !0, priority: 800, compile: function (e, o) {
                function r(e, r, c, s) {
                    var l = e.$parent;
                    if (e.$watch(function () {
                            return (l.$hasHeader ? " has-header" : "") + (l.$hasSubheader ? " has-subheader" : "") + (l.$hasFooter ? " has-footer" : "") + (l.$hasSubfooter ? " has-subfooter" : "") + (l.$hasTabs ? " has-tabs" : "") + (l.$hasTabsTop ? " has-tabs-top" : "")
                        }, function (e, t) {
                        ...
                        var u = {};
                        "true" !== o.overflowScroll && i.scrolling.jsScrolling() ? u = {
                            el: r[0],
                        ...
                        } : (r.addClass("overflow-scroll"), u = {
                            el: r[0],
                            delegateHandle: o.delegateHandle,
                            startX: e.$eval(e.startX) || 0,
                            startY: e.$eval(e.startY) || 0,
                            nativeScrolling: !0
                        }), t("$ionicScroll", {$scope: e, scrollViewOptions: u}), e.$on("$destroy", function () {
                            u && (u.scrollingComplete = g, delete u.el), a = null, r = null, o.$$element = null
                        })
                    }
                }
    ...
    l.directive("ionOptionButton", ["$compile", function (e) {
        function t(e) {
            e.stopPropagation()
        }

        return {
            restrict: "E", require: "^ionItem", priority: Number.MAX_VALUE, compile: function (e, n) {
                return n.$set("class", (n["class"] || "") + " button", !0), function (e, n, i, o) {
                    o.optionsContainer || (o.optionsContainer = v(_), o.$element.append(o.optionsContainer)), o.optionsContainer.append(n), o.$element.addClass("item-right-editable"), n.on("click", t)
                }
            }
        }
    }]);
    var z = '<div data-prevent-scroll="true" class="item-right-edit item-reorder enable-pointer-events"></div>';
    l.directive("ionReorderButton", ["$parse", function (e) {
        ...
        return function (e, t, n) {
            function i(e) {
                if (!ionic.Platform.isAndroid() || ionic.Platform.isFullScreen) {
                    ...
                    t.css("bottom", n + "px"), r = t.controller("$ionicScroll"), r && (r.scrollView.__container.style.bottom = n + a(t[0]) + "px")
                }
            }
            ...
            ionic.on("native.keyboardshow", i, window), ionic.on("native.keyboardhide", o, window), ionic.on("native.showkeyboard", i, window), ionic.on("native.hidekeyboard", o, window);
            var r;
            e.$on("$destroy", function () {
                ionic.off("native.keyboardshow", i, window), ionic.off("native.keyboardhide", o, window), ionic.off("native.showkeyboard", i, window), ionic.off("native.hidekeyboard", o, window)
            })
        }
        ...
        return {
            restrict: "E", link: function (e, t, n) {
                t.addClass("pane")
            }
        }
            ...
            restrict: "E", scope: !0, controller: function () {
                ...
                function o(e, i, o) {
                    ...
                    n(e, o, {
                        ...
                        minZoom: "@",
                        maxZoom: "@"
                    }), e.direction = e.direction || "y", f(o.padding) && e.$watch(o.padding, function (e) {
                ...
                var r = v('<div class="scroll"></div>');
                return r.append(e.contents()), e.append(r), {pre: o}
            }
        }
        ...
        return {
            restrict: "EA", require: "^ionSideMenus", scope: !0, compile: function (i, o) {
                function r(r, a, c, s) {
                    ...
                    var w = t.on("tap", l, a, $), b = t.on("dragright", u, a, $), y = t.on("dragleft", u, a, $), S = t.on("dragup", d, a, $), k = t.on("dragdown", d, a, $), C = t.on("release", h, a, $);
    ...
    }]), l.directive("ionSlideBox", ["$timeout", "$compile", "$ionicSlideBoxDelegate", "$ionicHistory", "$ionicScrollDelegate", function (e, t, n, i, o) {
        return {
            restrict: "E",
            replace: !0,
            transclude: !0,
            ...
            controller: ["$scope", "$element", "$attrs", function (t, r, a) {
                function c(e) {
                    e && !s.isScrollFreeze ? o.freezeAllScrolls(e) : !e && s.isScrollFreeze && o.freezeAllScrolls(!1), s.isScrollFreeze = e
                }

                var s = this, l = t.$eval(t.doesContinue) === !0, u = f(a.autoPlay) ? !!t.autoPlay : !1, d = u ? t.$eval(t.slideInterval) || 4e3 : 0, h = new ionic.views.Slider({
                    el: r[0],
                    auto: d,
                    continuous: l,
                    startSlide: t.activeSlide,
                    slidesChanged: function () {
                        t.currentSlide = h.currentIndex(), e(function () {
                        })
                    },
                    callback: function (n) {
                ...
                h.enableSlide(t.$eval(a.disableScroll) !== !0), t.$watch("activeSlide", function (e) {
                    f(e) && h.slide(e)
                ...
                t.$on("$destroy", p), this.slidesCount = function () {
            ...
            link: function (e, n, i, o) {
                function r() {
                    if (!a) {
                        var i = e.$new();
                        a = v("<ion-pager></ion-pager>"), n.append(a), a = t(a)(i)
                    }
                    return a
                }

                f(i.showPager) || (e.showPager = !0, r().toggleClass("hide", !1)), i.$observe("showPager", function (t) {
                    t = e.$eval(t), r().toggleClass("hide", !t)
                });
                var a
            }
        }
        ...
        return {
            restrict: "E", require: "^ionSlideBox", compile: function (e, t) {
                return e.addClass("slider-slide"), function (e, t, n) {
                }
            }
        }
    ...
    }]), l.directive("ionTabs", ["$ionicTabsDelegate", "$ionicConfig", "$ionicHistory", function (e, t, n) {
        return {
